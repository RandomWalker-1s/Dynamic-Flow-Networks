...
def build_corridor():
    ...
    for i in range(num_link):
        link = dfn.cell.Link(
            ...
            max_speed=max_speed, 
            initial_condition={'density': 100-i},
...
plt.plot([46.5, 46.5, 57.5, 57.5, 46.5], [-0.5, 9.5, 9.5, -0.5, -0.5], 'r-', linewidth=1)


plt.grid(True, which='minor')
plt.tight_layout()
plt.savefig('./Corridor_example_3.pdf')